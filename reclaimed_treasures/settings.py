"""
Django settings for reclaimed_treasures project.
...
# make email required to register for the site
...
WSGI_APPLICATION = 'reclaimed_treasures.wsgi.application'
...
if 'USE_AWS' in os.environ:
    #  Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'veras-reclaimed-treasures'
...
DEFAULT_FROM_EMAIL = 'verasreclaimedtreasures@example.com'
